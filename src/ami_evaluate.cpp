...
if(pole.alpha_.back()!=0 && parms.TYPE_!=AmiCalc::Pi_phuu && parms.TYPE_!=AmiCalc::Pi_phud  && parms.TYPE_ !=AmiCalc::doubleocc && parms.TYPE_!=AmiCalc::Pi_ppuu && parms.TYPE_!=Pi_ppud){
